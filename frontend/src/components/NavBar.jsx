  ...
  return (
    <div className='w-screen flex items-center justify-between text-sm p-5 px-12 mb-5 shadow-navbar'>
        ...
        <ul className='lg:flex items-start gap-5 text-md font-bold text-light hidden'>
             <NavLink className='bg-med w-30 p-1 text-center text-white rounded-2xl shadow-navButtonIn hover:bg-primary hover:scale-105' to='/'>
                <li className='py-1'>Home</li>
                {/* <hr className='border-none outline-none h-[1.5px] bg-whitesmoke w-10 m-auto hidden'/> */}
             </NavLink>
             <NavLink className='bg-med w-30 p-1 text-center text-white rounded-2xl shadow-navButtonIn hover:bg-primary hover:scale-105' to='/services'>
                <li className='py-1'>Services</li>
                <hr className='border-none outline-none h-[1.5px] bg-whitesmoke w-10 m-auto hidden'/>
             </NavLink>
             <NavLink className='bg-med w-30 p-1 text-center text-white rounded-2xl shadow-navButtonIn hover:bg-primary hover:scale-105' to='/about' >
                <li className='py-1'>About</li>
                <hr className='border-none outline-none h-[1.5px] bg-whitesmoke w-10 m-auto hidden'/>
             </NavLink>
             <NavLink className='bg-med w-30 p-1 text-center text-white rounded-2xl shadow-navButtonIn hover:bg-primary hover:scale-105' to='/contact'>
