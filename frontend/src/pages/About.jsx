...
const About = () => {
  return (
    <div className='px-8 md:px-18 mt-12'>
    ...
    <div className='flex flex-col items-center lg:flex-row lg:items-start pt-4 gap-5 lg:gap-12 mt-4 text-justify'>
        <img className='w-full xs:w-55 lg:mt-25 rounded-full' src={assets.about} alt="imagen corporativa" />
        <div className='flex flex-col justify-center gap-4 mt-5 text-sm md:text-md text-darkGray'>
          ...
          <h2 className='text-lg text-primary font-semibold text-center mt-6'>Nuestra Misión</h2>
      ...
      <div className='text-darkGray text-center text-lg mt-10 md:mt-12'>
        <p>¿Cómo hacemos la <span className='font-bold text-primary'>diferencia?</span></p>
      </div>

      <div className='grid mdlg:grid-cols-[repeat(3,1fr)] mdlg:gap-4 xl:gap-12 text-darkGray text-justify text-sm md:text-md py-3'>
        <div className='px-4 p-2 mdlg:p-5 hover:bg-extraLight cursor-pointer transition-all duration-200'>
        ...
        <div className='px-4 p-2 mdlg:p-5 hover:bg-extraLight cursor-pointer'>
